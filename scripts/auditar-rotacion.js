...
const MUSCULO = [
  ...
  [/gemelos/i, 'gemelos'],
  [/aductor/i, 'aductores'],
  [/abductor|abducci[oó]n|clamshells?|lateral band walks?/i, 'gluteo-medio'],
  [/hip thrust|puente de gl[uú]teo|patada de gl[uú]teo|kb swings?|kettlebell swings?/i, 'gluteo'],
  [/femoral|peso muerto rumano|buenos d[ií]as/i, 'isquios'],
  [/peso muerto|deadlift/i, 'cadena-posterior'],
  [/sentadilla|prensa|zancada|step[- ]?up|b[uú]lgara|hack|extensi[oó]n de cu[aá]driceps|split squat|pistol|back squat/i, 'cuadriceps'],
...
const PATRON = [
  ...
  [/abductor|abducci[oó]n|clamshells?|lateral band walks?/i, 'abduccion-cadera'],
  [/hip thrust|puente de gl[uú]teo|patada de gl[uú]teo|kb swings?|kettlebell swings?/i, 'extension-cadera'],
  [/peso muerto|buenos d[ií]as|deadlift|clean|snatch/i, 'bisagra'],
  [/femoral/i, 'aislamiento'],
  [/sentadilla|prensa|zancada|step[- ]?up|b[uú]lgara|hack|split squat|pistol|back squat/i, 'rodilla'],
...
const ACEPTADAS = [
  ...
  { de: 'kb swings', a: 'Peso muerto rumano con kettlebell',
    motivo: 'bisagra de cadera con el mismo material (misma regla, nombre corto "KB swings")' },
